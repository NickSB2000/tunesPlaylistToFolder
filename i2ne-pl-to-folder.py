...
def findTheBloodyTrack(plist=dict(), speculativeDrive=''):
  EXTENSION = ''
  LOCATION  = ''
  FOUND_SUCCESS = False
...
while True:  
  ...
  for item in trackList:
    ...
    FOUND_SUCCESS, speculativeDrive, LOCATION, EXTENSION = findTheBloodyTrack(plist=plist, speculativeDrive=speculativeDrive)
